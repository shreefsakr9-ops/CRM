...
export const DEFAULT_ROLE_PERMISSIONS: Record<RoleKey, Grant[]> = {
  ...
  OPERATIONS_MANAGER: [
    ...
    ['clients', ['view', 'edit', 'view_financial'], 'ALL'],
  ...
  SALES_MANAGER: [
    ...
    ['deals', ['view', 'create', 'edit', 'delete', 'restore', 'assign', 'approve', 'export'], 'TEAM'],
  ...
  SALES_AGENT: [
    ...
    ['deals', ['view', 'create', 'edit', 'assign'], 'OWN'],
    ['clients', ['view'], 'OWN'],
